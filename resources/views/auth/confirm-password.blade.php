...
<head>
    ...
    <title>Confirm Password - PEL</title>
    ...
    <div class="auth-wrapper">
        <div class="auth-card">
            ...
            <div class="flex flex-col items-center justify-center mb-6">
                ...
                <h2 class="text-2xl font-poppins font-bold text-gray-900 tracking-tight text-center">Secure Area</h2>
            </div>
            ...
            <!-- Back to Dashboard / Cancel Link -->
            <p class="text-center text-sm mt-8 text-gray-600">
                <a href="{{ url()->previous() }}" class="text-[#005baa] font-semibold hover:underline transition-colors">
                    Cancel and go back
                </a>
            </p>
        </div>
